...
class ApiClient {
  ApiClient({http.Client? client, String? analyzeUrl})
      : _client = client ?? http.Client(),
        _analyzeUrl = analyzeUrl ?? const String.fromEnvironment('ANALYZE_API_URL');
  ...
  Future<void> uploadVideo({
    ...
    try {
      ...
      // NOTE: We intentionally ignore the response body here. All
      // intelligence lives server-side for this MVP.
    } on TimeoutException {
